...
const Home: React.FC<HomePageProps> = ({ trending, popularMovies, topRatedTV, heroItems }) => {
  ...
  const schema = {
    ...
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://movieandtvshow.vercel.app/search?q={search_term_string}",
  ...
  return (
    <div className="min-h-screen bg-miraj-black pb-20">
      <SEO 
        title="Movie & Tv Show" 
        description="Movie & Tv Show - Official Site for free Movie and Tv Shows in HD quality. No registration required."
        schema={schema}
      />
