...
const About: React.FC = () => {
  const schema = {
    ...
    "@type": "AboutPage",
    "name": "About Movie & Tv Show",
    
    "description": "Movie & Tv Show is a premier streaming platform for movies, TV shows, and live sports.",
    "url": "https://movieandtvshow.vercel.app/about",
    "publisher": {
      "@type": "Organization",
      "name": "Movie & Tv Show",
      "logo": {
        "@type": "ImageObject",
        "url": "https://movieandtvshow.vercel.app/logo.png"
      }
    }
  };
  ...
  return (
    <div className="min-h-screen bg-miraj-black pt-24 pb-20">
      <SEO 
        title="About Us - Movie & Tv Show" 
        description="Learn more about Movie & Tv Show, our mission, and our commitment to free HD streaming." 
        schema={schema}
        path="/about"
      />
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-4xl">
        <div className="text-center mb-12">
            <h1 className="text-3xl md:text-5xl font-bold text-white mb-4">About <span className="text-miraj-red">Movie & Tv Show</span></h1>
        ...
        <div className="bg-miraj-gray border border-white/5 rounded-2xl p-6 md:p-10 mb-8">
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
                At Movie & Tv Show, our mission is simple: to provide a seamless, high-quality, and accessible streaming experience for entertainment lovers worldwide. 
