  ...
  return (
    <div className="container py-12">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        <p className="lead">Please read these Terms of Service carefully before using the Movie & Tv Show website.</p>
        ...
        <p>
          The website and its original content, features, and functionality are owned by Movie & Tv Show
        ...
        <ul>
          ...
          <li>
            Use the website to impersonate or attempt to impersonate Movie & Tv Show, a Movie & Tv Show employee, another user,
        ...
        <p>
        Movie & Tv Show provides links to streaming content hosted by third parties. We do not host any copyrighted
        ...
        <p>
          In no event shall Movie & Tv Show, nor its directors, employees, partners, agents, suppliers, or affiliates, be
