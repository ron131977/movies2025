    ...
    <div className="container py-12 text-center">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none mx-auto text-left">
        <p className="lead text-center text-xl font-semibold">
          <strong>Movie & Tv Show</strong> respects the intellectual property rights of others and complies with the Digital Millennium Copyright Act (DMCA).
        </p>

        <h2 className="text-3xl font-bold text-center mt-10">1. No Hosting of Content</h2>
        <p className="text-lg">Movie & Tv Show does not host, upload, or control any video content. All content displayed is sourced from publicly available third-party links.</p>
